...
**快速参考**：查看 [阶段二速查表](quick-reference.md) 获取常用函数和操作的快速参考。
...
1. **[语法基础](chapter-01-syntax/readme.md)**：语法基础、文件结构与编码规范。
...
2. **[输出与调试](chapter-02-output/readme.md)**：输出函数与调试技巧。
...
3. **[变量与常量](chapter-03-variables/readme.md)**：变量、常量与引用。
...
4. **[数据类型](chapter-04-types/readme.md)**：数据类型与检测。
...
5. **[类型转换与比较](chapter-05-type-casting/readme.md)**：类型转换与比较。
...
6. **[表达式与运算符](chapter-06-expressions/readme.md)**：表达式与运算符。
...
7. **[字符串操作](chapter-07-strings/readme.md)**：字符串处理与多字节支持。
...
8. **[数组完整指南](chapter-08-arrays/readme.md)**：数组操作与高阶函数。
...
9. **[控制结构](chapter-09-control-flow/readme.md)**：控制结构与循环。
