...
**时间分配建议：**
- PHP 发展史（1.0）：1 天
- PHP 和 MySQL 安装（1.1-1.2）：3-5 天
- 工具链配置（1.3）：3-5 天
- 配置和调试（1.4）：2-3 天
- Web 架构理解（1.5-1.7）：3-5 天
- 环境验证和练习：2-3 天
...
8. **[Worker、协程、Event Loop](chapter-08-workers/readme.md)**：Worker、协程、Event Loop（Worker 模式、协程、PHP 8 Fibers）。
   ...
   - [1.7.4 PHP 8 Fibers](chapter-08-workers/section-04-fibers.md)
   - [1.7.5 实际应用与最佳实践](chapter-08-workers/section-05-best-practices.md)
