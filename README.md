...
**重要说明**：本指南所有内容正在按照教材级标准编写和完善，部分阶段详细内容已完成，部分阶段为大纲状态请参考各阶段的 README 了解详细进度。
...
- [阶段一总览](docs/stage-01-foundation/readme.md) ✅ 已完成
...
- [1.5 PHP 配置与扩展](docs/stage-01-foundation/chapter-05-config/readme.md)
...
- [阶段二总览](docs/stage-02-language/readme.md) ✅ 已完成
...
- [阶段三总览](docs/stage-03-oop/readme.md) ✅ 已完成
...
- [阶段四总览](docs/stage-04-system/readme.md) ✅ 已完成
...
- [阶段五总览](docs/stage-05-web/readme.md) ✅ 已完成
...
- [阶段六总览](docs/stage-06-database/readme.md) ✅ 已完成
- [6.1 数据库设计基础](docs/stage-06-database/chapter-01-database-design/readme.md)
  - [6.1.1 数据库设计原则](docs/stage-06-database/chapter-01-database-design/section-01-design-principles.md)
  - [6.1.2 范式与反范式](docs/stage-06-database/chapter-01-database-design/section-02-normalization.md)
  - [6.1.3 索引设计](docs/stage-06-database/chapter-01-database-design/section-03-index-design.md)
- [6.2 PDO 入门与高安全模式](docs/stage-06-database/chapter-02-pdo/readme.md)
  - [6.2.1 PDO 基础与连接](docs/stage-06-database/chapter-02-pdo/section-01-pdo-basics.md)
  - [6.2.2 预处理语句与防注入](docs/stage-06-database/chapter-02-pdo/section-02-prepared-statements.md)
  - [6.2.3 CRUD 操作](docs/stage-06-database/chapter-02-pdo/section-03-crud-operations.md)
  - [6.2.4 高级特性](docs/stage-06-database/chapter-02-pdo/section-04-advanced-features.md)
- [6.3 并发控制与 MVCC](docs/stage-06-database/chapter-03-concurrency/readme.md)
  - [6.3.1 并发控制](docs/stage-06-database/chapter-03-concurrency/section-01-concurrency-control.md)
  - [6.3.2 MVCC 机制](docs/stage-06-database/chapter-03-concurrency/section-02-mvcc.md)
  - [6.3.3 锁机制](docs/stage-06-database/chapter-03-concurrency/section-03-locking.md)
- [6.4 ORM 框架与数据迁移](docs/stage-06-database/chapter-04-orm/readme.md)
  - [6.4.1 ORM 基础](docs/stage-06-database/chapter-04-orm/section-01-orm-basics.md)
  - [6.4.2 Eloquent 使用](docs/stage-06-database/chapter-04-orm/section-02-eloquent.md)
  - [6.4.3 数据迁移](docs/stage-06-database/chapter-04-orm/section-03-migrations.md)
  - [6.4.4 关系映射](docs/stage-06-database/chapter-04-orm/section-04-relationships.md)
- [6.5 Redis 缓存策略与性能优化](docs/stage-06-database/chapter-05-redis/readme.md)
  - [6.5.1 Redis 基础](docs/stage-06-database/chapter-05-redis/section-01-redis-basics.md)
  - [6.5.2 缓存策略](docs/stage-06-database/chapter-05-redis/section-02-cache-strategies.md)
  - [6.5.3 缓存问题与解决方案](docs/stage-06-database/chapter-05-redis/section-03-cache-problems.md)
  - [6.5.4 高级特性](docs/stage-06-database/chapter-05-redis/section-04-advanced-features.md)
- [6.6 数据库运维与管理](docs/stage-06-database/chapter-06-operations/readme.md)
  - [6.6.1 数据库连接池](docs/stage-06-database/chapter-06-operations/section-01-connection-pool.md)
  - [6.6.2 数据库备份与恢复](docs/stage-06-database/chapter-06-operations/section-02-backup-restore.md)
  - [6.6.3 消息队列基础](docs/stage-06-database/chapter-06-operations/section-03-message-queue.md)
- [6.7 数据库性能监控](docs/stage-06-database/chapter-07-monitoring/readme.md)
  - [6.7.1 数据库性能监控概述](docs/stage-06-database/chapter-07-monitoring/section-01-overview.md)
  - [6.7.2 慢查询分析](docs/stage-06-database/chapter-07-monitoring/section-02-slow-query.md)
  - [6.7.3 性能指标监控](docs/stage-06-database/chapter-07-monitoring/section-03-metrics.md)
- [6.8 其他数据库](docs/stage-06-database/chapter-08-other-databases/readme.md)
  - [6.8.1 其他关系型数据库](docs/stage-06-database/chapter-08-other-databases/section-01-other-relational.md)
  - [6.8.2 NoSQL 数据库](docs/stage-06-database/chapter-08-other-databases/section-02-nosql.md)

### 阶段七：高级架构与设计模式（Advanced Architecture & Design Patterns）

**定位**：设计原则，设计模式、架构模式、高级架构设计

- [阶段七总览](docs/stage-07-architecture/readme.md) ✅ 已完成
- [7.1 SOLID 原则](docs/stage-07-architecture/chapter-01-solid/readme.md)
  - [7.1.1 SOLID 原则概述](docs/stage-07-architecture/chapter-01-solid/section-01-overview.md)
  - [7.1.2 单一职责原则（SRP）](docs/stage-07-architecture/chapter-01-solid/section-02-srp.md)
  - [7.1.3 开闭原则（OCP）](docs/stage-07-architecture/chapter-01-solid/section-03-ocp.md)
  - [7.1.4 里氏替换原则（LSP）](docs/stage-07-architecture/chapter-01-solid/section-04-lsp.md)
  - [7.1.5 接口隔离原则（ISP）](docs/stage-07-architecture/chapter-01-solid/section-05-isp.md)
  - [7.1.6 依赖倒置原则（DIP）](docs/stage-07-architecture/chapter-01-solid/section-06-dip.md)
  - [7.1.7 SOLID 原则实践](docs/stage-07-architecture/chapter-01-solid/section-07-practice.md)
- [7.2 设计模式（Design Patterns）](docs/stage-07-architecture/chapter-02-design-patterns/readme.md)
  - [7.2.1 设计模式概述](docs/stage-07-architecture/chapter-02-design-patterns/section-01-overview.md)
  - [7.2.2 创建型模式](docs/stage-07-architecture/chapter-02-design-patterns/section-02-creational.md)
  - [7.2.3 结构型模式](docs/stage-07-architecture/chapter-02-design-patterns/section-03-structural.md)
  - [7.2.4 行为型模式](docs/stage-07-architecture/chapter-02-design-patterns/section-04-behavioral.md)
  - [7.2.5 设计模式实践](docs/stage-07-architecture/chapter-02-design-patterns/section-05-practice.md)
- [7.3 应用架构模式](docs/stage-07-architecture/chapter-03-architecture-patterns/readme.md)
  - [7.3.1 MVC 架构模式](docs/stage-07-architecture/chapter-03-architecture-patterns/section-01-mvc.md)
  - [7.3.2 ADR 架构模式](docs/stage-07-architecture/chapter-03-architecture-patterns/section-02-adr.md)
  - [7.3.3 模块化单体架构](docs/stage-07-architecture/chapter-03-architecture-patterns/section-03-modular-monolith.md)
  - [7.3.4 架构模式对比与选择](docs/stage-07-architecture/chapter-03-architecture-patterns/section-04-comparison.md)
- [7.4 异常体系与框架级设计](docs/stage-07-architecture/chapter-04-exceptions/readme.md)
  - [7.4.1 异常体系层次](docs/stage-07-architecture/chapter-04-exceptions/section-01-exception-hierarchy.md)
  - [7.4.2 自定义异常](docs/stage-07-architecture/chapter-04-exceptions/section-02-custom-exceptions.md)
  - [7.4.3 框架级异常设计](docs/stage-07-architecture/chapter-04-exceptions/section-03-framework-design.md)
  - [7.4.4 异常处理最佳实践](docs/stage-07-architecture/chapter-04-exceptions/section-04-best-practices.md)
- [7.5 六边形架构](docs/stage-07-architecture/chapter-05-hexagonal/readme.md)
  - [7.5.1 六边形架构概述](docs/stage-07-architecture/chapter-05-hexagonal/section-01-overview.md)
  - [7.5.2 Ports（端口）](docs/stage-07-architecture/chapter-05-hexagonal/section-02-ports.md)
  - [7.5.3 Adapters（适配器）](docs/stage-07-architecture/chapter-05-hexagonal/section-03-adapters.md)
  - [7.5.4 六边形架构实践](docs/stage-07-architecture/chapter-05-hexagonal/section-04-practice.md)
- [7.6 DDD 领域驱动设计初级入门](docs/stage-07-architecture/chapter-06-ddd/readme.md)
  - [7.6.1 DDD 概述与分层](docs/stage-07-architecture/chapter-06-ddd/section-01-overview.md)
  - [7.6.2 实体与值对象](docs/stage-07-architecture/chapter-06-ddd/section-02-entities-value-objects.md)
  - [7.6.3 聚合根（Aggregate Root）](docs/stage-07-architecture/chapter-06-ddd/section-03-aggregates.md)
  - [7.6.4 仓储模式](docs/stage-07-architecture/chapter-06-ddd/section-04-repositories.md)
  - [7.6.5 领域服务与领域事件](docs/stage-07-architecture/chapter-06-ddd/section-05-domain-services-events.md)
  - [7.6.6 DDD 实践指南](docs/stage-07-architecture/chapter-06-ddd/section-06-practice.md)
- [7.7 数据流设计进阶](docs/stage-07-architecture/chapter-07-data-flow/readme.md)
  - [7.7.1 CQRS 模式](docs/stage-07-architecture/chapter-07-data-flow/section-01-cqrs.md)
  - [7.7.2 事件溯源（Event Sourcing）](docs/stage-07-architecture/chapter-07-data-flow/section-02-event-sourcing.md)
  - [7.7.3 事件总线（Event Bus）](docs/stage-07-architecture/chapter-07-data-flow/section-03-event-bus.md)
  - [7.7.4 数据流设计实践](docs/stage-07-architecture/chapter-07-data-flow/section-04-practice.md)
- [7.8 微服务架构基础](docs/stage-07-architecture/chapter-08-microservices/readme.md)
  - [7.8.1 微服务概述与服务拆分](docs/stage-07-architecture/chapter-08-microservices/section-01-overview-splitting.md)
  - [7.8.2 服务间通信](docs/stage-07-architecture/chapter-08-microservices/section-02-communication.md)
  - [7.8.3 微服务挑战与解决方案](docs/stage-07-architecture/chapter-08-microservices/section-03-challenges-solutions.md)
  - [7.8.4 微服务实践指南](docs/stage-07-architecture/chapter-08-microservices/section-04-practice.md)

### 阶段八：性能优化与安全（Performance & Security）

**定位**：性能优化，安全防护、测试体系

- [阶段八总览](docs/stage-08-performance-security/readme.md) 📋 大纲
- [8.1 安全防护](docs/stage-08-performance-security/chapter-01-security/readme.md) 📋 大纲
  - [8.1.1 OWASP Top 10（2025）风险模型与防御](docs/stage-08-performance-security/chapter-01-security/section-01-owasp.md)
  - [8.1.2 密码与加密安全](docs/stage-08-performance-security/chapter-01-security/section-02-encryption.md)
  - [8.1.3 Secrets 管理](docs/stage-08-performance-security/chapter-01-security/section-03-secrets.md)
  - [8.1.4 安全 HTTP 头](docs/stage-08-performance-security/chapter-01-security/section-04-http-headers.md)
  - [8.1.5 API 安全](docs/stage-08-performance-security/chapter-01-security/section-05-api-security.md)
  - [8.1.6 安全审计与日志](docs/stage-08-performance-security/chapter-01-security/section-06-audit.md)
  - [8.1.7 依赖安全](docs/stage-08-performance-security/chapter-01-security/section-07-dependency-security.md)
- [8.2 性能优化](docs/stage-08-performance-security/chapter-02-performance/readme.md) 📋 大纲
  - [8.2.1 PHP 性能优化](docs/stage-08-performance-security/chapter-02-performance/section-01-php-optimization.md)
  - [8.2.2 OPcache 配置](docs/stage-08-performance-security/chapter-02-performance/section-02-opcache.md)
  - [8.2.3 代码优化技巧](docs/stage-08-performance-security/chapter-02-performance/section-03-code-optimization.md)
  - [8.2.4 数据库深度优化](docs/stage-08-performance-security/chapter-02-performance/section-04-db-optimization.md)
  - [8.2.5 性能监控](docs/stage-08-performance-security/chapter-02-performance/section-05-monitoring.md)
  - [8.2.6 性能测试](docs/stage-08-performance-security/chapter-02-performance/section-06-performance-testing.md)
- [8.3 现代 PHP 运行时](docs/stage-08-performance-security/chapter-03-runtime/readme.md) 📋 大纲
  - [8.3.1 RoadRunner](docs/stage-08-performance-security/chapter-03-runtime/section-01-roadrunner.md)
  - [8.3.2 FrankenPHP](docs/stage-08-performance-security/chapter-03-runtime/section-02-frankenphp.md)
  - [8.3.3 OpenSwoole](docs/stage-08-performance-security/chapter-03-runtime/section-03-openswoole.md)
  - [8.3.4 Laravel Octane](docs/stage-08-performance-security/chapter-03-runtime/section-04-laravel-octane.md)
  - [8.3.5 运行时对比与选择](docs/stage-08-performance-security/chapter-03-runtime/section-05-comparison.md)
- [8.4 Worker、协程、Event Loop](docs/stage-08-performance-security/chapter-04-workers/readme.md) 📋 大纲
- [8.5 异步与分布式处理](docs/stage-08-performance-security/chapter-05-async/readme.md) 📋 大纲
- [8.6 测试体系建设](docs/stage-08-performance-security/chapter-06-testing/readme.md) 📋 大纲
- [8.7 Mock、Stub，Fakes 深度讲解](docs/stage-08-performance-security/chapter-07-mocking/readme.md) 📋 大纲
- [8.8 TDD（测试驱动开发）](docs/stage-08-performance-security/chapter-08-tdd/readme.md) 📋 大纲
- [8.9 BDD（行为驱动开发）](docs/stage-08-performance-security/chapter-09-bdd/readme.md) 📋 大纲
- [8.10 代码覆盖率深入](docs/stage-08-performance-security/chapter-10-coverage/readme.md) 📋 大纲
- [8.11 可观测性体系](docs/stage-08-performance-security/chapter-11-observability/readme.md) 📋 大纲

### 阶段九：现代框架深度应用（Framework）

**定位**：框架应用、IoC/DI、路由、中间件等

- [阶段九总览](docs/stage-09-frameworks/readme.md) 📋 大纲
- [9.1 IoC 与 DI 设计模式深度理解](docs/stage-09-frameworks/chapter-01-ioc-di/readme.md) 📋 大纲
- [9.2 路由、中间件、Pipeline](docs/stage-09-frameworks/chapter-02-middleware/readme.md) 📋 大纲
- [9.3 Laravel（2025 最新特性）](docs/stage-09-frameworks/chapter-03-laravel/readme.md) 📋 大纲
- [9.4 Symfony](docs/stage-09-frameworks/chapter-04-symfony/readme.md) 📋 大纲
- [9.5 其他现代框架](docs/stage-09-frameworks/chapter-05-other-frameworks/readme.md) 📋 大纲
- [9.6 框架对比与选型指南](docs/stage-09-frameworks/chapter-06-comparison/readme.md) 📋 大纲
- [9.7 框架性能优化](docs/stage-09-frameworks/chapter-07-performance/readme.md) 📋 大纲
- [9.8 框架最佳实践总结](docs/stage-09-frameworks/chapter-08-best-practices/readme.md) 📋 大纲

### 阶段十：部署，云原生与 DevOps（DevOps）

**定位**：部署、容器、CI/CD、监控等

- [阶段十总览](docs/stage-10-devops/readme.md) 📋 大纲
- [10.1 专业 Dockerfile](docs/stage-10-devops/chapter-01-dockerfile/readme.md) 📋 大纲
- [10.2 docker-compose 与本地开发环境](docs/stage-10-devops/chapter-02-docker-compose/readme.md) 📋 大纲
- [10.3 镜像安全](docs/stage-10-devops/chapter-03-security/readme.md) 📋 大纲
- [10.4 部署选择](docs/stage-10-devops/chapter-04-deployment/readme.md) 📋 大纲
- [10.5 Kubernetes (K8s)](docs/stage-10-devops/chapter-05-kubernetes/readme.md) 📋 大纲
- [10.6 Serverless PHP](docs/stage-10-devops/chapter-06-serverless/readme.md) 📋 大纲
- [10.7 CI/CD 与 GitHub Actions](docs/stage-10-devops/chapter-07-cicd/readme.md) 📋 大纲
- [10.8 Deploy 策略](docs/stage-10-devops/chapter-08-strategies/readme.md) 📋 大纲
- [10.9 GitOps](docs/stage-10-devops/chapter-09-gitops/readme.md) 📋 大纲
- [10.10 IaC](docs/stage-10-devops/chapter-10-iac/readme.md) 📋 大纲
- [10.11 回滚与灾备](docs/stage-10-devops/chapter-11-rollback/readme.md) 📋 大纲
- [10.12 监控](docs/stage-10-devops/chapter-12-monitoring/readme.md) 📋 大纲
- [10.13 API 网关](docs/stage-10-devops/chapter-13-api-gateway/readme.md) 📋 大纲
- [10.14 负载均衡](docs/stage-10-devops/chapter-14-load-balancing/readme.md) 📋 大纲
- [10.15 CDN](docs/stage-10-devops/chapter-15-cdn/readme.md) 📋 大纲

### 阶段十一：实战项目（Projects）

**定位**：综合项目实践

- [阶段十一总览](docs/stage-11-projects/readme.md) 📋 待开始

### 阶段十二：附言（Appendix）

**定位**：PSR 标准、Composer 高级

- [阶段十二总览](docs/stage-12-appendix/readme.md) 📋 待开始
- [12.1 PSR 标准详解](docs/stage-12-appendix/chapter-01-psr-standards/readme.md) 📋 待开始
- [12.2 Composer 高级应用](docs/stage-12-appendix/chapter-02-composer-advanced/readme.md) 📋 待开始
